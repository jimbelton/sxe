 ...
 */
int
sophos_sha1_init(sophos_sha1_ctx_t *context)
{
 ...
 */
int
sophos_sha1_final(sophos_sha1_ctx_t *context, char *digest)
{
    static int attempts = 0;
    int i, j, x;
 ...
 */
int
sophos_sha1_update(sophos_sha1_ctx_t *context, const char *message_array, size_t length)
{
    static int attempts = 0;
 ...
 */
char *
sophos_sha1(const char *msg, size_t length, char *md)
{
    static int attempts = 0;
 ...
 */
static void
SHA1ProcessMessageBlock(sophos_sha1_ctx_t *context)
{
 ...
 */
static void
SHA1PadMessage(sophos_sha1_ctx_t *context)
{
    /*
 ...
 */
int
sophos_sha1_init_config(int attempts)
{
 ...
 */
int
sophos_sha1_update_config(int attempts)
{
 ...
 */
int
sophos_sha1_final_config(int attempts)
{
 ...
 */
int
sophos_sha1_config(int attempts)
{
...
void
sophos_sha1_fail_next_call(void)
{
    fail_next_call = 1;
}
